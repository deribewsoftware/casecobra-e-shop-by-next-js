...
font-bold
 !leading-tight
 text-gray-900 mt-16
 text-5xl md:text-6xl lg:text-7xl">Your Image on <span className="bg-green-600 px-2 text-white">Custom</span> Phone Case</h1>
 ...
 <p className="mt-8 lg:pr-10 max-w-prose text-lg text-center lg:text-left text-balance md:text-wrap">
  Capture your favorite memories with your own, <span className=" font-semibold">one-of-one </span>
   phone case.
   CaseCobra Project Your Phone Memories,not just your phone case.
  </p>

  <ul className=" font-medium space-y-2 flex flex-col mt-8 text-left items-center sm:items-start">
    <div className="space-y-2">
      <li className="flex gap-1.5 text-left items-center">
        <Check className=" shrink-0 h-5 w-5 text-green-600"/>
  ...
  <div className="mt-12 flex flex-col sm:flex-row items-center gap-5 sm:items-start">
    <div className="flex -space-x-4">
      <img src="/users/user-1.png" alt="user image" className="w-10 h-10 inline-block rounded-full ring-2 ring-slate-100"/>
      <img src="/users/user-2.png" alt="user image" className="w-10 h-10 inline-block rounded-full ring-2 ring-slate-100"/>
      <img src="/users/user-3.png" alt="user image" className="w-10 h-10 inline-block rounded-full ring-2 ring-slate-100"/>
      <img src="/users/user-4.jpg" alt="user image" className="w-10 h-10 inline-block rounded-full ring-2 ring-slate-100"/>
      <img src="/users/user-5.jpg" alt="user image" className="w-10 object-cover h-10 inline-block rounded-full ring-2 ring-slate-100"/>
    </div>
<div className="flex  flex-col justify-between items-center sm:items-start">
  ...
  <p><span className=" font-semibold">1.250</span> happy customers</p>
        ...
        <div className="col-span-full lg:col-span-1 w-full px-8 sm:px-16 md:px-0 flex justify-center mt-32 lg:mx-0 lg:mt-20 h-fit">
          <div className="relative md:max-w-xl">
            <img src="/your-image.png" alt="" className=" absolute w-40 lg:w-52 left-56 
            -top-20 select-none
             hidden sm:block lg:hidden xl:block
            "/>
            <img src="/line.png" alt="" className="absolute -left-6 -bottom-6 select-none" />
